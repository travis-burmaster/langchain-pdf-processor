...
def main(pdf_directory=None):
    ...
    # Use the provided file path or fall back to the environment variable
    pdf_directory = pdf_directory or os.getenv("PATH_TO_FILES")
    
    if not pdf_directory:
        raise ValueError("PDF directory is not specified. Please provide a file path or set the PATH_TO_FILES environment variable.")
